...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.23.5 clang-2100.3.23.3)
#ifndef DRIVEMOUNTFILEPROVIDER_SWIFT_H
#define DRIVEMOUNTFILEPROVIDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DriveMountFileProvider",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSURL;
SWIFT_CLASS("_TtC22DriveMountFileProvider31DriveMountFileProviderExtension")
@interface DriveMountFileProviderExtension : NSObject <NSFileProviderReplicatedExtension>
...
- (void)importDidFinishWithCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)materializedItemsDidChangeWithCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
...
SWIFT_CLASS("_TtC22DriveMountFileProvider22FileProviderEnumerator")
@interface FileProviderEnumerator : NSObject <NSFileProviderEnumerator>
- (void)invalidate;
- (void)enumerateItemsForObserver:(id <NSFileProviderEnumerationObserver> _Nonnull)observer startingAtPage:(NSFileProviderPage _Nonnull)page;
- (void)enumerateChangesForObserver:(id <NSFileProviderChangeObserver> _Nonnull)observer fromSyncAnchor:(NSFileProviderSyncAnchor _Nonnull)syncAnchor;
- (void)currentSyncAnchorWithCompletionHandler:(void (^ _Nonnull)(NSFileProviderSyncAnchor _Nullable))completionHandler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class NSNumber;
@class NSDate;
SWIFT_CLASS("_TtC22DriveMountFileProvider16FileProviderItem")
@interface FileProviderItem : NSObject <NSFileProviderItem>
@property (nonatomic, readonly) NSFileProviderItemIdentifier _Nonnull itemIdentifier;
@property (nonatomic, readonly) NSFileProviderItemIdentifier _Nonnull parentItemIdentifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull filename;
@property (nonatomic, readonly, copy) UTType * _Nonnull contentType;
@property (nonatomic, readonly, strong) NSNumber * _Nullable documentSize;
@property (nonatomic, readonly, copy) NSDate * _Nullable contentModificationDate;
@property (nonatomic, readonly, strong) NSFileProviderItemVersion * _Nonnull itemVersion;
