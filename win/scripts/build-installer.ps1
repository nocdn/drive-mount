...
$bootstrapperProject = Join-Path $repoRoot 'win\installer\CloudDriveMount.bootstrapper.wixproj'
...
$installerPath = Join-Path $repoRoot "win\installer\bin\$Configuration\CloudDriveMount.bootstrapper.exe"
